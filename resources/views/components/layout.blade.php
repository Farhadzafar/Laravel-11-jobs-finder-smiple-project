                ...
                <!-- add jobs button end -->
                  ...
                  <div class="relative ml-3">
                    <div>
                      ...
                      <a href="/farhad" aria-current="page">
          ...
          <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
              <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                  <div class="text-base/5 font-medium text-white">Farhad Ahmad Zafari</div>
                  <div class="text-sm font-medium text-gray-400">farhadzafari10@gmail.com</div>
                </div>
